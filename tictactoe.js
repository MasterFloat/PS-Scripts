...
var TicTacToe = (function () {
        ...
        TicTacToe.prototype.getGrid = function () {
                ...
                var grid = '<table cellspacing = "0">' +
                        ...
                        '<button name = "send" value = "/ttt end"><small>End Game</small></button>';
                return grid;
        };
        ...
        TicTacToe.prototype.markBox = function (user, num) {
                ...
                if (typeof this.markers[num] === 'string') return this.updateUser(user, 'That box has already been marked.');
        ...
        TicTacToe.prototype.update = function () {
                var message = '|html|<center><b><span style = "color:' + Core.color(this.currentPlayer.userid) + '">' + this.currentPlayer.name + '\'s turn!</span></b><br/>' + this.getGrid();
        ...
        TicTacToe.prototype.declareDraw = function () {
                var message = '|html|<center><b>Draw between' + this.p1.name + ' and ' + this.p2.name + '!</b><br>' + this.getGrid();
                this.players.forEach(function (user) {
                        user.popup(message);
                });
                this.end();
        ...
        TicTacToe.prototype.declareWinner = function () {
                var message = '|html|<center><b>' + this.currentPlayer.name + ' has won the game!</b><br/>' + this.getGrid();
                this.players.forEach(function (user) {
                        user.popup(message);
                });
                this.end();
        ...
        TicTacToe.prototype.resetTimer = function () {
                clearTimeout(this.timer);
                this.timer = setTimeout(this.end.bind(this, 'The game has been ended due to player inactivity.'), 30 * 1000);
        };
